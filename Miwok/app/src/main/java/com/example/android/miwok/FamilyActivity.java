...
public class FamilyActivity extends AppCompatActivity {
    ...
    /**
     * Clean up the media player by releasig its resources.
     */
    private void releaseMediaPlayer(){
        ...
        if(mMediaPlayer!=null){
            ...
            //Regardless of whether or not we were granted audiio focus, abandon it. This also unregister the AudioFocusChangeListener so we don't get anymore callbacks.
